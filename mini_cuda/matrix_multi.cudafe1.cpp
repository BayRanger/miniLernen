...
# 14 "matrix_multi.cu"
void matrixMultCuda(int *a, int *b, int *c, int width) ;
#if 0
# 15
{ 
# 16
int k, sum = 0; 
# 17
int col = (__device_builtin_variable_threadIdx.x) + ((__device_builtin_variable_blockDim.x) * (__device_builtin_variable_blockIdx.x)); 
# 18
int row = (__device_builtin_variable_threadIdx.y) + ((__device_builtin_variable_blockDim.y) * (__device_builtin_variable_blockIdx.y)); 
# 19
...
#endif
# 30 "matrix_multi.cu"
void matrixMult(int a[16][16], int b[16][16], int c[16][16], int width) 
# 31
{ 
# 32
...
dim3 dimBlock(16, 16); 
# 65
(__cudaPushCallConfiguration(dimGrid, dimBlock)) ? (void)0 : matrixMultCuda(dev_a, dev_b, dev_c, 16); 
# 67
cudaMemcpy(c, dev_c, size, cudaMemcpyDeviceToHost); 
# 69
cudaFree(dev_a); cudaFree(dev_b); cudaFree(dev_c); 
# 71
matrixMult(a, b, c, 16); return 0; 
# 72
} 

# 1 "matrix_multi.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__b289beff_15_matrix_multi_cu_13d95b8b
#ifdef _NV_ANON_NAMESPACE
#endif
# 1 "matrix_multi.cudafe1.stub.c"
#include "matrix_multi.cudafe1.stub.c"
# 1 "matrix_multi.cudafe1.stub.c"
